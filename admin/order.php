					 ...
					 if(mysqli_num_rows($res)>0){
						...
						<tr>
							...
							<td>
							 ...
							 <td>
								<div class="order_status_<?php echo $row['order_status']?>"><?php echo ucfirst($row['order_status'])?></div>
							</td>
							
							<td>
								<div class="payment_type<?php echo $row['payment_type']?>"><?php echo ucfirst($row['payment_type'])?></div>
							</td>
							<td>
							<?php 
